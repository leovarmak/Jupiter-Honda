...
f(document).ready(function () { 
	 ...
	 var slt1=f( "input:radio[name=osemi-loantenure]:checked" ).val();    
...
function validatemonth(input){
		if (input.value < 0) input.value = 0;
		if (input.value > 84) input.value = 84;
		} 
							
function calculateEMI(obj) {
var chkVal=f( "input:radio[name=osemi-loantenure]:checked" ).val();
var inputVal=f("#tenure" ).val();
if(chkVal=='osemi-loanyears'){
	if (inputVal < 0) f("#tenure" ).val(0);
		if (inputVal > 7) f("#tenure" ).val(7);
}
else if(chkVal=='osemi-loanmonths')
{
	if (inputVal < 0) f("#tenure" ).val(0);
		if (inputVal > 84) f("#tenure" ).val(84);
}
...
f(document).ready(function () { 
  f(".showtable a.btnred").click(function(){
	  f("#emipaymenttable").slideToggle();
 });
});